...
| **4 · Synaptic Pruning** | prune ½ of synapses | **Static pruning vs dynamic firing: dynamic tolerates 60% removal free, static collapses at 30% (+29%).** Adaptivity ≈ 2× sparsity. |
